...
**Please submit a memo that uses full sentences and does not include any code chunks interspersed. As a challenge, try to format your tables and figure following [APA 7 guidelines](https://owl.purdue.edu/owl/research_and_citation/apa_style/apa_formatting_and_style_guide/apa_tables_and_figures.html) (you will not be graded on this).** 
...
2.2 Formally test your hypothesis using an Ordinary Least Squares estimation strategy. Report your results in a formatted table. **(2 points)**

2.3 Interpret the results of your test in 1-2 sentences. **(2 points)**

2.4. Assess the quality of your model fit using the $R^2$ statistic. **(1 point)**

2.5. Select an alpha-threshold and describe the corresponding confidence interval for your estimates of the relationship between $frpl$ and $ppe$. **(1 point)**

2.5 Imagine you are an analyst working for Colt Gill, Director of the Oregon Department of Education. You have been tasked with describing to him whether schools with greater levels of student financial need receive more money. Write a short paragraph reporting the results of your analysis, while introducing appropriate caveats and nuances as needed. **(1 point)**
