...
1.1. Re-state your interpretation of the results of your hypothesis test from Assignment 1, Question 2.4 and add to it a paragraph in which you state the assumptions you have made in using an Ordinary Least Squares estimator to describe this relationship. **(2 points)**

1.2. Examine the school called "South Eugene High School" (*ncesid* == 410474000573) in the NERD$ data. Characterize its observed values of per-pupil expenditure and the proportion of students at the school classified as low-family-income. How do these values differ from the predicted values for this school? **(2 points)**
