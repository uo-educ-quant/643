...
- Shouldn't assume it will go up
]
...
---
# Cubics
.small[We needn't restrict ourselves to transformations to normality to only quadratic relationships. Many relationships, for example are cubic (third-power) in nature.]
