...
- **Applied** quantitative social scientist focused on improving leadership and policy
- **Not** a methodologist
]
...
- More examples of actually doing the analysis
- More examples of write-up
- More opportunities to collaborate with classmates (engage in active learning)
- Clearer explanation of some concepts in class lectures

--


### A wondering:
- Many students did not submit polished final products for their assignments, do we need to grade for this?
...
5. Five (5) data analytic assignments (12% each) + final project (30% of grade)
