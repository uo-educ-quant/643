...
* Values range from -1 to 1
  + Positive Values - Y increases as X increases
  - Negative Values - Y decreases as X increases

* Summarizes the degree to which y increases (or decreases) as x increases.
