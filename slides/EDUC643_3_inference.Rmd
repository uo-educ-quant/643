...
--
.small[**A one unit difference in dietary restraint is positively associated with a 1.03 difference in BMI.**]
...
$$t = \frac{\hat{\beta_1} - 0}{SE(\hat{\beta_1})} = \frac{1.0349}{.136} = 7.61$$
$$Pr(t < -7.61 \text{ or } t > 7.61)|H_0 = 0.000000000000058 \text{ or } p <0.001$$
---
