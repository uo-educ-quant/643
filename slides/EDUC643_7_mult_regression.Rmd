...
This can straightforward to detect, such as when two of our predictors are strongly related to one another:
...
.small[Some believe that any instances of multicollinearity in your predictors are cause for concern and you should determine whether any of your covariates have a high degree of collinearity with each other, and if so, you should correct for it] 
...
### Reading: 
- **Finish by Feb. 2**: LSWR Chapter 15.3 if not done already!
