...
```{R, setup, include = F}
library(pacman)
p_load(here, tidyverse, ggplot2, xaringan, knitr, kableExtra, haven, broom, xaringanthemer, reshape2, car)
...
do <- read_spss(here::here("data/male_do_eating.sav")) %>% 
  ...
  mutate(marital_status = as.character(marital_status),
         marital_status = case_when(marital_status == "1" ~ "single",
                                    marital_status == "2" ~ "single but committed relationship",
                                    marital_status == "4" ~ "engaged",
                                    marital_status == "5" ~ "married but separated",
                                    marital_status == "6" ~ "married",
                                    marital_status == "7" ~ "widowed",
                                    marital_status == "8" ~ "divorced"
                                    ),
...
```{r, echo = F}
status <- c("single", "married", "engaged", "single but committed relationship")
do2 <- do %>% 
